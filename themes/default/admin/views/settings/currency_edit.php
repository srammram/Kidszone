...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("system_settings/edit_currency/".$id, $attrib); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_currency', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
