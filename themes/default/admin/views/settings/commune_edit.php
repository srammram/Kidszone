...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_commune'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator','class' => 'edit_from', 'role' => 'form');
        echo admin_form_open_multipart("system_settings/edit_commune/".$id, $attrib); ?>
        <div class="modal-body">
            ...
            District Name*
                ...
                echo form_dropdown('district_id', $c, $result->district_id, 'class="form-control select"  id="district_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_commune', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
