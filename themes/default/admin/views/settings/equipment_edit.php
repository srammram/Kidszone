...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('edit_equipment'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator','class' => 'edit_from', 'role' => 'form');
        echo admin_form_open_multipart("system_settings/edit_equipment/".$id, $attrib); ?>
        <div class="modal-body">
           <h2 class="box_he_de"> <?= lang('enter_info'); ?></h2>
            ...
            <div class="form-group">
            Price*
                <?php echo form_input('price', $result->price, 'class="form-control" id="price" required="required"'); ?>
            </div>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_equipment', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
