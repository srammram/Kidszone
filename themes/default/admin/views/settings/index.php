    ...
    <div class="box-content">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <?php
                                $tm = array(12 => '12 Hrs',  24 => '24 Hrs');
                                    echo form_dropdown('time_format', $tm, $Settings->time_format, 'class="form-control tip" id="time_format" required="required" style="width:100%;"');                                
                                ?>
                            </div>
                        </div>
                    </div>                    
			...
			'Pacific/Fiji'         => "GMT+12:00",
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang('module_permission', 'module_permission'); ?>
                            </br>
                            <input type="radio" value="1" id="module_permission_group" class="checkbox" name="module_permission" <?php echo ($Settings->module_permission=="1") ? "checked" : ''; ?>>
                            <label for="module_permission_group" class="padding03"><?= lang('group_permission') ?></label>   
                            <input type="radio" value="2" id="module_permission_user" class="checkbox" name="module_permission" <?php echo ($Settings->module_permission=="2") ? "checked" : ''; ?>>
                            <label for="module_permission_user" class="padding03"><?= lang('user_permission') ?></label>
                           
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang('transaction_date', 'transaction_date'); ?>
                            </br>
                            <input type="radio" value="1" id="transaction_date_auto" class="checkbox" name="transaction_date" <?php echo ($Settings->transaction_date=="1") ? "checked" : ''; ?>>
                            <label for="transaction_date_auto" class="padding03"><?= lang('auto') ?></label>   
                            <input type="radio" value="2" id="transaction_date_manual" class="checkbox" name="transaction_date" <?php echo ($Settings->transaction_date=="2") ? "checked" : ''; ?>>
                            <label for="transaction_date_manual" class="padding03"><?= lang('manual') ?></label>
                           
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label" for="today_transaction_date"><?= lang("today_transaction_date"); ?></label>
                            <?= form_input('today_transaction_date', $today_transac_date, 'class="transaction-datepicker form-control tip" id=""'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label" for="supply_chain_enable" style="padding: 4px 7px 4px 0px;"><?= lang("supply_chain"); ?></label>
                            <div class="switch-field">
                            
                                <input type="radio" value="0"  id="supply_chain-switch-left" class="switch_left skip" name="supply_chain" <?php echo ($Settings->supply_chain==0) ? "checked" : ''; ?>>
                                <label for="supply_chain-switch-left">OFF</label>
                                <input type="radio" value="1" id="supply_chain-switch-right" class="switch_right skip" name="supply_chain" <?php echo ($Settings->supply_chain==1) ? "checked" : ''; ?>>
                                <label for="supply_chain-switch-right">ON</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="clear: both;height: 10px;"></div>
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                            <?= lang('rough_tender', 'rough_tender'); ?>
                            <?php $rough_tender_opt = array(1 => lang('Enable'), 0 => lang('disable'));?>
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('dine_in_discount_settings') ?></legend>
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="manual_item_discount" style="padding: 4px 7px;"><?= lang("manual_item_discount"); ?></label>
                                    <div class="switch-field">
                                    
                                    <input type="radio" value="0"  id="manual_item_discount-switch-left" class="switch_left skip" name="manual_item_discount" <?php echo ($Settings->manual_item_discount==0) ? "checked" : ''; ?>>
                                    <label for="manual_item_discount-switch-left">OFF</label>
                                    <input type="radio" value="1" id="manual_item_discount-switch-right" class="switch_right skip" name="manual_item_discount" <?php echo ($Settings->manual_item_discount==1) ? "checked" : ''; ?>>
                                    <label for="manual_item_discount-switch-right">ON</label>
                                    </div>
                                </div>
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('store_login') ?></legend>
                            <div class="col-md-12">
                                 <div class="col-md-3">
                                    <div class="form-group">
                                         <input type="checkbox" value="1" id="single_store" class="checkbox" name="store_type" <?php echo ($Settings->store_type==1) ? "checked" : ''; ?>>
                                        <label for="single_store" class="padding03"><?= lang('single_store') ?></label>
                                    </div>  
                                </div>
                               
                                <div class="col-md-3" id="login_group_required_container">
                                    <div class="form-group">
                                        
                                        <label class="control-label" for="login_group_required"><?= lang("login_group_required"); ?></label>
                                        <div class="switch-field">
                                        
                                        <input type="radio" value="0" id="g_switch_left" class="skip" name="login_group_required" <?php echo ($Settings->login_group_required==0) ? "checked" : ''; ?>>
                                        <label for="g_switch_left">No</label>
                                        <input type="radio" value="1" id="g_switch_right" class="skip" name="login_group_required" <?php echo ($Settings->login_group_required==1) ? "checked" : ''; ?>>
                                        <label for="g_switch_right">YES</label>
                                        </div>
                                    </div>  
                                </div>
                                 <div class="col-md-4" id="login_warehouse_required_container">
                                    <div class="form-group">
                                        <label class="control-label" for="login_warehouse_required"><?= lang("login_warehouse_required"); ?></label>
                                        <div class="switch-field">
                                        
                                        <input type="radio" value="0" id="w_switch_left" class="skip warehouse_not_required" name="login_warehouse_required" <?php echo ($Settings->login_warehouse_required==0) ? "checked" : ''; ?>>
                                        <label for="w_switch_left">No</label>
                                        <input type="radio" value="1" id="w_switch_right" class="skip warehouse_required" name="login_warehouse_required" <?php echo ($Settings->login_warehouse_required==1) ? "checked" : ''; ?>>
                                        <label for="w_switch_right">YES</label>
                                        </div>
                                    </div>  
                                </div>
                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('app_settings') ?></legend>
                            <div class="col-md-12">
                                 <div class="col-md-4">                    
                                    <div class="form-group">
                                        <label class="control-label" for="order_request_stewardapp" style="padding: 4px 7px 4px 0px;"><?= lang("Bill_Request_Stewardapp"); ?></label>
                                        <div class="switch-field">
                                 ...
                                 <div class="col-md-4">                    
                                    <div class="form-group">
                                        <label class="control-label" for="discount_request_customer_app" style="padding: 4px 7px 4px 0px;"><?= lang("discount_request_customer_app"); ?></label>
                                        <div class="switch-field">
                                        
                                        <input type="radio" value="0"  id="customerapp-switch-left" class="switch_left skip" name="discount_request_customer_app" <?php echo ($Settings->discount_request_customer_app==0) ? "checked" : ''; ?>>
                                        <label for="customerapp-switch-left">OFF</label>
                                        <input type="radio" value="1" id="customerapp-switch-right" class="switch_right skip" name="discount_request_customer_app" <?php echo ($Settings->discount_request_customer_app==1) ? "checked" : ''; ?>>
                                        <label for="customerapp-switch-right">ON</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">                    
                                <div class="form-group">
                                    <label class="control-label" for="special_item_enable" style="padding: 4px 7px 4px 0px;"><?= lang("special_item_enable"); ?></label>
                                    <div class="switch-field">
                                    
                                    <input type="radio" value="0"  id="special_item_enable-switch-left" class="switch_left skip" name="special_item_enable" <?php echo ($Settings->special_item_enable==0) ? "checked" : ''; ?>>
                                    <label for="special_item_enable-switch-left">OFF</label>
                                    <input type="radio" value="1" id="special_item_enable-switch-right" class="switch_right skip" name="special_item_enable" <?php echo ($Settings->special_item_enable==1) ? "checked" : ''; ?>>
                                    <label for="special_item_enable-switch-right">ON</label>
                                    </div>
                                </div>
                            </div>
                    </fieldset>
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label" for="exchange_decimals"><?= lang("exchange_decimals"); ?></label>
                                <div class="controls"> <?php
                                    $exchange_decimals = array(0 => lang('disable'), 1 => '1', 2 => '2', 3 => '3', 4 => '4');
                                    echo form_dropdown('exchange_decimals', $exchange_decimals, $Settings->exchange_decimals, 'class="form-control tip" id="exchange_decimals"  style="width:100%;" required="required"');
                                    ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                 <div class="form-group socket_port">
                                    ...
                                    <?= form_input('socket_port', ($Settings->socket_port!=0)?$Settings->socket_port:'', 'class="form-control numberonly" readonly="readonly" id="socket_port"'); ?>
...
<script>
	...
	$('.month-date-picker').datepicker({
        ...
        $('.warehouse_not_required').click(function(){
            if (!$('#single_store').is(':checked')) {
                bootbox.alert('warehouse not required option only available for single store');
                return false;
            }
        });
        $('#single_store').on("ifChanged",function(e){
            $checked = e.target.checked;
            if (!$checked) {
                $('.warehouse_required').trigger('click');
            }
