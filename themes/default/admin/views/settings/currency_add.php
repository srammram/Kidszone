...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("system_settings/add_currency", $attrib); ?>
        <div class="modal-body">
            <h2 class="box_he_de"> <?= lang('enter_info'); ?></h2>
            
            <div class="col-md-6">
            <div class="form-group">
                <?php $code = $this->site->commoncode('CU', 'currency'); ?>
                <?= lang('code', 'code'); ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_currency', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
