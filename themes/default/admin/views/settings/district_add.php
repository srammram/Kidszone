...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_district'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'class' => 'add_from', 'role' => 'form');
        echo admin_form_open_multipart("system_settings/add_district", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="col-md-12">
                ...
                <?php $code = $this->site->commoncode('D', 'district'); ?>
                <?= lang('code', 'code'); ?>
             ...
             <div class="form-group col-md-12 col-xs-12">
                ...
                echo form_dropdown('province_id', $c, '', 'class="form-control select"  id="province_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_district', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
...
$('#province_id').change(function(){
	$('#name').val('');
    $('.add_from').bootstrapValidator('revalidateField', 'name');
});
</script>