        ...
        <div class="row group-permission">
            <div class="col-lg-12">
                ...
                <?php if (!empty($p)) {
                    if ($p->group_id != 1) {
                        ...
                        echo admin_form_open($edit_link); ?>
				...
				<tr>
						        ...
						        <tr class="reports">
									...
									<ul>
										...
										<label for="feedback" class="padding05"><?= lang('feedback') ?></label>
									     ...
									     <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="modify_bills" name="reports-modify_bills" <?php echo $p->{'reports-modify_bills'} ? "checked" : ''; ?>>
										<label for="modify_bills" class="padding05"><?= lang('modify_bills') ?></label>
									    </span>
									    </li>

									     <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="restore_bills" name="reports-restore_bills" <?php echo $p->{'reports-restore_bills'} ? "checked" : ''; ?>>
										<label for="restore_bills" class="padding05"><?= lang('restore_bills') ?></label>
									    </span>
									    </li>
									    
									     <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="auto_modify_bills" name="reports-auto_modify_bills" <?php echo $p->{'reports-auto_modify_bills'} ? "checked" : ''; ?>>
										<label for="auto_modify_bills" class="padding05"><?= lang('auto_modify_bills') ?></label>
									    </span>
									    </li>
									     <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="items_mapping_for_modify_bills" name="reports-items_mapping_for_modify_bills" <?php echo $p->{'reports-items_mapping_for_modify_bills'} ? "checked" : ''; ?>>
										<label for="items_mapping_for_modify_bills" class="padding05"><?= lang('items_mapping_for_modify_bills') ?></label>
									    </span>
									    </li>
									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-monthly_reports" name="reports-monthly_reports" <?php echo $p->{'reports-monthly_reports'} ? "checked" : ''; ?>>
										<label for="reports-monthly_reports" class="padding05"><?= lang('reports-monthly_reports') ?></label>
									    </span>
									    </li>
									</ul>
								    </td>
		                        ...
		                        <?php if ($Owner || $Admin ) { ?>
                                <tr>
                                    <td><?= lang("include_reports_view_access"); ?></td>
                                    <td colspan="5">
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="bulk_actions"
                                            name="include_reports_view_access" <?php echo $p->include_reports_view_access ? "checked" : ''; ?>>
                                            <label for="include_reports_view_access" class="padding05"><?= lang('print') ?></label>
                                        </span>
                                        <span style="inline-block">
                                            <input type="checkbox" value="1" class="checkbox" id="exclude_reports_view_access"
                                            name="exclude_reports_view_access" <?php echo $p->exclude_reports_view_access ? "checked" : ''; ?>>
                                            <label for="exclude_reports_view_access" class="padding05"><?= lang("don't print") ?></label>
                                        </span>
                                    </td>
                                </tr>
                                <?php } ?>
                            ...
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                 ...
                                 <tr class="orders-settings">
									...
									<label for="pos-bil_generator" class="padding05"><?= lang('bill_generator') ?></label>
									</span>
									</li>
									<li>
										<span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="pos-app_bil_generator"
										name="pos-app_bil_generator" <?php echo $p->{'pos-app_bil_generator'} ? "checked" : ''; ?>>
										<label for="pos-app_bil_generator" class="padding05"><?= lang('app_bil_generator') ?></label>
										</span>
									</li>

									<li>
										<span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="bbq_daywise_discount_edit_permission"
										name="bbq_daywise_discount_edit_permission" <?php echo $p->{'bbq_daywise_discount_edit_permission'} ? "checked" : ''; ?>>
										<label for="bbq_daywise_discount_edit_permission" class="padding05"><?= lang('bbq_daywise_discount_edit_permission') ?></label>
										</span>
									</li>
                                    ...
                                    <td colspan="5">
										...
										<li>
					                        <span style="inline-block">
					                            ...
					                            <label for="pos-bil_cancel" class="padding05"><?= lang('bill_cancel') ?></label>
					                        </span>
										</li>
										<li>
						                    <span style="inline-block">
						                        ...
						                        <label for="pos-bil_payment" class="padding05"><?= lang('bill_payment') ?></label>
						                    </span>
										</li>
										<li>
					                        <span style="inline-block">
					                            ...
					                            <label for="pos-bil_print" class="padding05"><?= lang('bill_print') ?></label>
					                        </span>
										</li>
										<li>
					                    <span style="inline-block">
										...
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-shifttime_report"
					                            name="pos-shifttime_report" <?php echo $p->{'pos-shifttime_report'} ? "checked" : ''; ?>>
					                            <label for="pos-shifttime_report" class="padding05"><?= lang('pos-shifttime_report') ?></label>
					                        </span>
										</li>
										<li>
					                        <span style="inline-block">
										...
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-reprint"
					                            name="pos-reprint" <?php echo $p->{'pos-reprint'} ? "checked" : ''; ?>>
					                            <label for="pos-reprint" class="padding05"><?= lang('reprint') ?></label>
					                        </span>
										</li>
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-hold_sales"
					                            name="pos-hold_sales" <?php echo $p->{'pos-hold_sales'} ? "checked" : ''; ?>>
					                            <label for="pos-hold_sales" class="padding05"><?= lang('hold_sales') ?></label>
					                        </span>
										</li>
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-cancel_sales"
					                            name="pos-cancel_sales" <?php echo $p->{'pos-cancel_sales'} ? "checked" : ''; ?>>
					                            <label for="pos-cancel_sales" class="padding05"><?= lang('cancel_sales') ?></label>
					                        </span>
										</li>	
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-resettle_sales"
					                            name="pos-resettle_sales" <?php echo $p->{'pos-resettle_sales'} ? "checked" : ''; ?>>
					                            <label for="pos-resettle_sales" class="padding05"><?= lang('resettle_sales') ?></label>
					                        </span>
										</li>	
										<li>
					                        <span style="inline-block">
					                            <input type="checkbox" value="1" class="checkbox" id="pos-qsr_bill_print"
			 ...
			 <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped settings-table">
                               ...
                               <tr>
                                    <th colspan="6"
                                        class="text-center"><?= lang("settings"); ?><?php echo  $page_title; ?></th>
                                </tr>
                                </thead>
                                <tbody>
				    <tr>
					...
					<span style="inline-block">
								...
								<td colspan="5">
									...
									<label for="system_settings-change_logo" class="padding05"><?= lang('logo_change') ?></label>
								    </span>
										...
										<input type="checkbox" value="1" class="checkbox" id="system_settings-group_permissions"
										name="system_settings-group_permissions" <?php echo $p->{'system_settings-group_permissions'} ? "checked" : ''; ?>>
										<label for="system_settings-group_permissions" class="padding05"><?= lang('group_permissions') ?></label>
									    </span>
					...
					<td colspan="5">
					    <span style="inline-block">					    
						<input type="checkbox" value="1" class="checkbox" id="system_settings-bbq_menu"
						name="system_settings-bbq_menu" <?php echo $p->{'system_settings-bbq_menu'} ? "checked" : ''; ?>>
						<label for="system_settings-bbq_menu" class="padding05"><?= lang('view') ?></label>
					    </span>
					    <span style="inline-block">					    
						<input type="checkbox" value="1" class="checkbox" id="system_settings-add_bbq_menu"
						name="system_settings-add_bbq_menu" <?php echo $p->{'system_settings-add_bbq_menu'} ? "checked" : ''; ?>>
						<label for="system_settings-add_bbq_menu" class="padding05"><?= lang('add') ?></label>
					    </span>
					    <span style="inline-block">					    
						<input type="checkbox" value="1" class="checkbox" id="system_settings-edit_bbq_menu"
						name="system_settings-edit_bbq_menu" <?php echo $p->{'system_settings-edit_bbq_menu'} ? "checked" : ''; ?>>
						<label for="system_settings-edit_bbq_menu" class="padding05"><?= lang('edit') ?></label>
					    </span>
					    <span style="inline-block">					    
						<input type="checkbox" value="1" class="checkbox" id="system_settings-delete_bbq_menu"
						name="system_settings-delete_bbq_menu" <?php echo $p->{'system_settings-delete_bbq_menu'} ? "checked" : ''; ?>>
						<label for="system_settings-delete_bbq_menu" class="padding05"><?= lang('delete') ?></label>
					    </span>
					</td>
				    </tr>				    
				    <tr>
			...
			<div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                    <th colspan="6"
                                        class="text-center"><?= $this->lang->line("procurment_permissions"); ?></th>
                                </tr>
                                <tr>
                                    <th rowspan="2" class="text-center"><?= lang("module_name"); ?>
                                    </th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="store_request-index" id="store_request-index" <?php echo $p->{'store_request-index'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('list'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="store_request-add" id="store_request-add" <?php echo $p->{'store_request-add'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('add'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="store_request-edit" id="store_request-edit" <?php echo $p->{'store_request-edit'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('edit'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="store_request-delete" id="store_request-delete" <?php echo $p->{'store_request-delete'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('delete'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                           <input type="checkbox" value="1" name="store_request-view" id="store_request-view" <?php echo $p->{'store_request-view'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('view'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="store_request-approved" id="store_request-approved" <?php echo $p->{'store_request-approved'} ? "checked" : ''; ?>>
						...
						<tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="production-index" id="production-index" <?php echo $p->{'production-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="production-add" id="production-add" <?php echo $p->{'production-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="production-edit" id="production-edit" <?php echo $p->{'production-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="production-delete" id="production-delete" <?php echo $p->{'production-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="production-view" id="production-view" <?php echo $p->{'production-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="production-approved" id="production-approved" <?php echo $p->{'production-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
						...
						<tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="request-index" id="request-index" <?php echo $p->{'request-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="request-add" id="request-add" <?php echo $p->{'request-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="request-edit" id="request-edit" <?php echo $p->{'request-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="request-delete" id="request-delete" <?php echo $p->{'request-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="request-view" id="request-view" <?php echo $p->{'request-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="request-approved" id="request-approved" <?php echo $p->{'request-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="quotes-index" id="quotes-index" <?php echo $p->{'quotes-index'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('list'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="quotes-add" id="quotes-add" <?php echo $p->{'quotes-add'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('add'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                           <input type="checkbox" value="1" name="quotes-edit" id="quotes-edit" <?php echo $p->{'quotes-edit'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('edit'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="quotes-delete" id="quotes-delete" <?php echo $p->{'quotes-delete'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('delete'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="quotes-view" id="quotes-view" <?php echo $p->{'quotes-view'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('view'); ?></label>
                                                        </span>
                                                        <span style="display:inline-block;">
                                                            <input type="checkbox" value="1" name="quotes-approved" id="quotes-approved" <?php echo $p->{'quotes-approved'} ? "checked" : ''; ?>>
                                                            <label  class="padding05"><?= lang('approved'); ?></label>
                                                        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_orders-index" id="purchase_orders-index" <?php echo $p->{'purchase_orders-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_orders-add" id="purchase_orders-add" <?php echo $p->{'purchase_orders-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="purchase_orders-edit" id="purchase_orders-edit" <?php echo $p->{'purchase_orders-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_orders-delete" id="purchase_orders-delete" <?php echo $p->{'purchase_orders-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_orders-view" id="purchase_orders-view" <?php echo $p->{'purchase_orders-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_orders-approved" id="purchase_orders-approved" <?php echo $p->{'purchase_orders-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_invoices-index" id="purchase_invoices-index" <?php echo $p->{'purchase_invoices-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_invoices-add" id="purchase_invoices-add" <?php echo $p->{'purchase_invoices-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="purchase_invoices-edit" id="purchase_invoices-edit" <?php echo $p->{'purchase_invoices-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_invoices-delete" id="purchase_invoices-delete" <?php echo $p->{'purchase_invoices-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_invoices-view" id="purchase_invoices-view" <?php echo $p->{'purchase_invoices-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_invoices-approved" id="purchase_invoices-approved" <?php echo $p->{'purchase_invoices-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
						...
						<tr>
                                                	<td width="200"><?= lang('purchase_returns'); ?></td>
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_returns-index" id="purchase_returns-index" <?php echo $p->{'purchase_returns-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_returns-add" id="purchase_returns-add" <?php echo $p->{'purchase_returns-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="purchase_returns-edit" id="purchase_returns-edit" <?php echo $p->{'purchase_returns-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_returns-delete" id="purchase_returns-delete" <?php echo $p->{'purchase_returns-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_returns-view" id="purchase_returns-view" <?php echo $p->{'purchase_returns-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="purchase_returns-approved" id="purchase_returns-approved" <?php echo $p->{'purchase_returns-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
                                                ...
                                                <tr>
                                                	<td width="200"><?= lang('purchase_transfer'); ?></td>
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_transfers-index" id="store_transfers-index" <?php echo $p->{'store_transfers-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_transfers-add" id="store_transfers-add" <?php echo $p->{'store_transfers-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="store_transfers-edit" id="store_transfers-edit" <?php echo $p->{'store_transfers-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_transfers-delete" id="store_transfers-delete" <?php echo $p->{'store_transfers-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_transfers-view" id="store_transfers-view" <?php echo $p->{'store_transfers-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_transfers-approved" id="store_transfers-approved" <?php echo $p->{'store_transfers-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
                                                ...
                                                <tr>
                                                	<td width="200"><?= lang('store_receive'); ?></td>
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_receivers-index" id="store_receivers-index" <?php echo $p->{'store_receivers-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_receivers-add" id="store_receivers-add" <?php echo $p->{'store_receivers-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="store_receivers-edit" id="store_receivers-edit" <?php echo $p->{'store_receivers-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_receivers-delete" id="store_receivers-delete" <?php echo $p->{'store_receivers-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_receivers-view" id="store_receivers-view" <?php echo $p->{'store_receivers-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_receivers-approved" id="store_receivers-approved" <?php echo $p->{'store_receivers-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_returns-index" id="store_returns-index" <?php echo $p->{'store_returns-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_returns-add" id="store_returns-add" <?php echo $p->{'store_returns-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="store_returns-edit" id="store_returns-edit" <?php echo $p->{'store_returns-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_returns-delete" id="store_returns-delete" <?php echo $p->{'store_returns-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_returns-view" id="store_returns-view" <?php echo $p->{'store_returns-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_returns-approved" id="store_returns-approved" <?php echo $p->{'store_returns-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
                                                        </span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="5">
                                                    	<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_return_receivers-index" id="store_return_receivers-index" <?php echo $p->{'store_return_receivers-index'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('list'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_return_receivers-add" id="store_return_receivers-add" <?php echo $p->{'store_return_receivers-add'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('add'); ?></label>
							</span>
							<span style="display:inline-block;">
							   <input type="checkbox" value="1" name="store_return_receivers-edit" id="store_return_receivers-edit" <?php echo $p->{'store_return_receivers-edit'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('edit'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_return_receivers-delete" id="store_return_receivers-delete" <?php echo $p->{'store_return_receivers-delete'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('delete'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_return_receivers-view" id="store_return_receivers-view" <?php echo $p->{'store_return_receivers-view'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('view'); ?></label>
							</span>
							<span style="display:inline-block;">
							    <input type="checkbox" value="1" name="store_return_receivers-approved" id="store_return_receivers-approved" <?php echo $p->{'store_return_receivers-approved'} ? "checked" : ''; ?>>
							    <label  class="padding05"><?= lang('approved'); ?></label>
							</span>
