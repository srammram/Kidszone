...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("system_settings/add_village", $attrib); ?>
        <div class="modal-body">
            ...
            <div class="col-md-12">
                ...
                <?php $code = $this->site->commoncode('V', 'village'); ?>
                <?= lang('code', 'code'); ?>
            ...
            <div class="form-group col-md-12 col-xs-12">
                ...
                echo form_dropdown('district_id', $d, '', 'class="form-control select"  id="district_id" required="required"'); ?>
            </div>
            <div class="form-group col-md-12 col-xs-12">
               Commune Name*
				<?php
                ...
                echo form_dropdown('commune_id', $c, '', 'class="form-control select"  id="commune_id" required="required"'); ?>
            </div>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_village', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
