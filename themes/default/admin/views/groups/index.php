<script>
	...
	function active_status(x) {
        ...
        var y = x.split("__");
		return y[1] == 1 ?
		"<a href='#' class='tip po' title='' data-content=\"<p>Are you Sure</p><a class='btn btn-danger' id='a__$1' href=' <?= admin_url('groups/groups_status/deactive/') ?>"+ y[0] +" '>Yes I`m Sure</a> <button class='btn po-close'>No</button>\"  rel='popover'><span class=\"label label-success\">"+lang['active']+"</span> </a>"
			:

		"<a href='#' class='tip po' title='' data-content=\"<p>Are you Sure</p><a class='btn btn-danger' id='a__$1' href=' <?= admin_url('groups/groups_status/active/') ?>"+ y[0] +" '>Yes I`m Sure</a> <button class='btn po-close'>No</button>\"  rel='popover'><span class=\"label label-danger\">"+lang['inactive']+"</span> </a>"
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('groups/getGroups?sdate='.$_GET['sdate'].'&edate='.$_GET['edate']) ?>',
            'fnServerData': function (sSource, aoData, fnCallback) {
             ...
             //"aoColumns": [ null, null, null, {"mRender": mobile_status}, null,  {"mRender": active_status},  {"bSortable": true}]
             "aoColumns": [ null, {"mRender": active_status}, null ]
        });
    });
</script>
    ...
    <div class="box-content">    
        <div class="row">
            ...
            <div class="clearfix"></div>
            	...
            	<a href="<?= admin_url('staff/add_staff'); ?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> <?= lang("add_staff"); ?></button></a>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                             ...
                             <th class="col-xs-3"><?php echo lang('status'); ?></th>
