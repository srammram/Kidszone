...
<?php $attrib = array('class' => 'form-horizontal', 'class' => 'add_from','data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off"); echo admin_form_open_multipart("nationality/edit_nationality/".$id, $attrib); ?>
  ...
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-sm-12 last_sa_se"><?php echo form_submit('edit_nationality', lang('submit'), 'class="btn btn-primary"'); ?></div>
         </div>
    </div>
  </div>
</div>
         ...
         fields: {
			name: {
                 validators: {
					...
					remote: {
							type: 'POST',
							url: '<?=admin_url('nationality/get_name')?>',
