<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('sgm/getSgm?sdate='.$_GET['sdate'].'&edate='.$_GET['edate']) ?>',
    ...
    <div class="box-content">
        ...
        <div class="row">
            ...
            <div class="clearfix"></div>
            	...
            	<a href="<?= admin_url('sgm/add_sgm'); ?>"><button type="button" class="btn btn-primary pull-right"><i class="fa fa-plus-circle"></i> <?= lang("add_sgm"); ?></button></a>
