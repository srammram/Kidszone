  ...
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
		...
		<fieldset class="scheduler-border">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="code" id="code"  value="<?= $result->code ?>">
							</div>						
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label class="label_green">Latitude</label>
								<input type="text" class="form-control" name="lat" id="lat"  value="<?= $result->lat ?>">
							</div>
							<div class="form-group">
								<label class="label_green">Longitude</label>
								<input type="text" class="form-control" name="lng" id="lng"  value="<?= $result->lng ?>">
							</div>
						</div>
					</div>
                    ...
                    <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="device_ip" id="device_ip"  value="<?= $result->device_ip ?>">
							</div>
						</div>
					</div>
				</fieldset>
        ...
        <div class="col-sm-12 last_sa_se"><?php echo form_submit('edit_outlet', lang('submit'), 'class="btn btn-primary"'); ?></div>
         </div>
    </div>
  </div>
</div>
