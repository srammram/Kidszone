...
<?php $attrib = array('class' => 'form-horizontal', 'class' => 'add_from','data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off"); echo admin_form_open_multipart("age/edit_age/".$id, $attrib); ?>
  ...
  <div class="box-content">
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-sm-12 last_sa_se"><?php echo form_submit('edit_age', lang('submit'), 'class="btn btn-primary"'); ?></div>
         </div>
    </div>
  </div>
</div>
