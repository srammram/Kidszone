    ...
    <div class="row">
      <div class="col-lg-12">
        <?php $attrib = array('class' => 'form-horizontal', 'class' => 'add_from','data-toggle' => 'validator', 'role' => 'form', 'autocomplete' => "off");
                echo admin_form_open_multipart("safety/safety_add", $attrib);
                ?>
        <div class="row">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<textarea rows="5" style="width: 100%;" name="desc_msg" id="desc_msg"></textarea>
							</div>
						</div>
					</div>
			</fieldset>
        </div>
        <div class="col-sm-12 last_sa_se"><?php echo form_submit('safety_add', lang('submit'), 'class="btn btn-primary"'); ?></div>
