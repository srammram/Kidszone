						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<?php
									...
									echo form_dropdown('occupation', $o, $result->occupation, 'class="form-control select"  readonly id="occupation" required="required" disabled'); 
								?> 
							</div>
                            <div class="form-group">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<?php
									...
									echo form_dropdown('wife_occupation', $o, $result->wife_occupation, 'class="form-control select"  readonly id="wife_occupation" required="required" disabled'); 
								?> 
							</div>
