...
function loadItems() {
	...
	var $total_no_qty=0;
	    ...
	    tr_html +='<td>'+
            ...
            tr_html += '<td><input class="form-control text-center po_quantity numberonly" name="po_quantity[]" type="text"  value="' + formatQuantity2(item_po_qty) + '" data-id="' + row_no + '" data-item="' + item_id + '" id="po_quantity_' + row_no + '"></td>';
