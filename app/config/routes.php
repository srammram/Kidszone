...
//$route['api/login']["post"] = 'api/v1/login/index_post';
//$route["api/v1/apicontroller"]["get"] = "api/v1/apicontroller/index_get"; //basico
//$route["api/v1/apicontroller/(:num)"]["get"] = "api/v1/apicontroller/find"; //select
//$route["api/v1/apicontroller"]["post"] = "api/v1/apicontroller/index_post"; //insert
//$route["api/v1/apicontroller/(:num)"]["put"] = "api/v1/apicontroller/index_put/$1"; //update
...
$route['admin/user-stores'] = 'admin/auth/user_stores';
...
$route['admin/tables/(:num)'] = 'admin/tables/index/$1';
$route['admin/products/(:num)'] = 'admin/products/index/$1';
$route['admin/recipe/(:num)'] = 'admin/recipe/index/$1';
...
$route['admin/terms_conditions'] = 'admin/pages/terms_conditions';
