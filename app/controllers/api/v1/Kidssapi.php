...
class Kidssapi extends REST_Controller {
	...
	function __construct() {
		...
		$this->load->api_model('kids_api_local');
	...
	public function register_post(){
		...
		if ($this->form_validation->run() == false) {
				...
				echo "login success !!!!! Welcome user".$user_pass;
				/*$res = $this->kids_api_local->insertRegister($data);
				if($res == TRUE){
